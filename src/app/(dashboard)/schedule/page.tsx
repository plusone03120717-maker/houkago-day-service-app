...
export default async function SchedulePage({
  ...
  const { data: customEventsRaw } = await supabase
    ...
    .select('id, title, event_type, event_date, start_time, end_time, all_day, note, child_id, children(id, name), schedule_event_children(child_id, children(id, name)), schedule_event_staff(staff_id, users(id, name))')
...
export type CustomEventRaw = {
  ...
  schedule_event_staff: { staff_id: string; users: { id: string; name: string } | null }[]
}
