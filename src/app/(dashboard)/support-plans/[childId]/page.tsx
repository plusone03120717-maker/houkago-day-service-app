...
export default async function SupportPlanDetailPage({
  ...
  const { data: plansRaw } = await supabase
    .from('support_plans')
    .select('id, plan_date, review_date, status, long_term_goals, short_term_goals, support_content, support_health_life, support_movement_sensory, support_cognition_behavior, support_language_communication, support_social_relationships, support_transition, support_family, monitoring_notes, long_term_goal_rating, short_term_goal_rating, created_at')
    .eq('child_id', childId)
