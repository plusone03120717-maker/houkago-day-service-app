...
export function SupportBot() {
  ...
  return (
    <div className="relative">
      ...
      {/* お知らせメニューと同じく、アイコンの真下に開く */}
      {open && (
        <div className="absolute right-0 top-11 z-50 flex max-h-[min(38rem,calc(100vh-6rem))] w-[min(24rem,calc(100vw-2.5rem))] flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-2xl">
          {/* ヘッダー */}
